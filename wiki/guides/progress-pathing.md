...
This recipe is for downstream vendored engines. For Vizzer’s own source checkout,
use the [self-host login-service instructions](../../vizzer/README.md#stable-address-and-automatic-login-startup).
