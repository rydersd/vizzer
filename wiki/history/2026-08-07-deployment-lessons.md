...
> Historical record. Preserved from `docs/field-report-2026-08-07.md`; dated claims and scope are not current product authority. See the [current product contract](../../product-spec/current-behavior.md).
