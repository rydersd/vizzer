...
> Historical record. Preserved from `docs/superpowers/specs/2026-08-06-vizzer-portable-spec-views-design.md`; dated claims and scope are not current product authority. See the [current product contract](../../product-spec/current-behavior.md).
