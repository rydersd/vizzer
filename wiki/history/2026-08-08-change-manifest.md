...
> Historical record. Preserved from `docs/superpowers/specs/codex-sequence-2026-08-08-change-manifest.md`; dated claims and scope are not current product authority. See the [current product contract](../../product-spec/current-behavior.md).
